...
const DEFAULT_LIGHT_MAP_STYLE = 'mapbox://styles/mapbox/streets-v12'
...
export function useMapThemeStyle(lightStyle?: string, darkStyle?: string): string {
  ...
  return useMemo(() => {
    const resolvedLight = lightStyle ?? process.env.NEXT_PUBLIC_MAPBOX_STYLE ?? DEFAULT_LIGHT_MAP_STYLE
