...
export const metadata: Metadata = buildEventLandingMetadata(EVENT_LANDING_CONFIGS.culture)

export default async function EventosCulturalesLojaPage() {
  const config = EVENT_LANDING_CONFIGS.culture
