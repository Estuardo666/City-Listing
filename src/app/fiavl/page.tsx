...
export const metadata: Metadata = buildEventLandingMetadata(EVENT_LANDING_CONFIGS.fiavl)

export default async function FiavlPage() {
  const config = EVENT_LANDING_CONFIGS.fiavl
