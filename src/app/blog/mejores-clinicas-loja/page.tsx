...
const config = RANKED_VENUE_ARTICLE_CONFIGS.find((article) => article.slug === 'mejores-clinicas-loja')!

export const metadata: Metadata = {
  title: config.title,
  description: config.description,
  alternates: { canonical: 'https://viveloja.com/blog/mejores-clinicas-loja' },
  openGraph: {
    title: config.title,
    description: config.description,
    url: 'https://viveloja.com/blog/mejores-clinicas-loja',
    type: 'article',
    locale: 'es_EC',
    siteName: 'Vive Loja',
  },
...
export default async function MejoresClinicasLojaPage() {
