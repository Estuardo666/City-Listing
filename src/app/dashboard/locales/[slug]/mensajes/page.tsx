...
interface VenueMessagesPageProps {
  params: Promise<{ slug: string }>
}

export default function VenueMessagesPage({ params }: VenueMessagesPageProps) {
  ...
  useEffect(() => {
    if (selectedConversation && venueId) {
      loadMessages()
    }
  ...
  const loadConversations = async () => {
    try {
      const response = await fetch(`/api/venues/${slug}/conversations`)
      if (response.ok) {
