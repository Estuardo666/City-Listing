...
export const metadata: Metadata = buildEventLandingMetadata(EVENT_LANDING_CONFIGS.arts)

export default async function ArtesVivasLojaPage() {
  const config = EVENT_LANDING_CONFIGS.arts
