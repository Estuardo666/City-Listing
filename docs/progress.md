...
- HEAD documental actual: `4af281f` sobre la rama de CP9; el código funcional `6b9b72e` y su endurecimiento de vistas tienen verdes [CI push 33591366787](https://github.com/Estuardo666/City-Listing/actions/runs/33591366787) y [CI PR 33591369607](https://github.com/Estuardo666/City-Listing/actions/runs/33591369607), incluido seguimiento, insignias, contraseña, recomendaciones, transmisiones, guardados enriquecidos y la regresión de role público. El smoke de producción también documenta que `NEXTAUTH_URL` sigue apuntando al host histórico y requiere corrección en Vercel; el checklist de migración incorpora la verificación. PR #2 permanece `CLEAN`; GitGuardian y Vercel Preview están verdes.
