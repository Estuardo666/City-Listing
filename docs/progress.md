...
- HEAD documental actual: `36cfe9b` (`[skip ci]`) sobre la rama de CP9; el código funcional anterior `4d416f0` tiene verdes [CI push 33572842559](https://github.com/Estuardo666/City-Listing/actions/runs/33572842559) y [CI PR 33572846382](https://github.com/Estuardo666/City-Listing/actions/runs/33572846382), incluido el resumen enriquecido de favoritos. PR #2 permanece `CLEAN`; GitGuardian y Vercel Preview están verdes.
