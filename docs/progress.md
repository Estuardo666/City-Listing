...
- HEAD documental actual: `9331ce6` sobre la rama de CP9; el código funcional `6b9b72e` y su endurecimiento de vistas tienen verdes [CI push 33590634104](https://github.com/Estuardo666/City-Listing/actions/runs/33590634104) y [CI PR 33590635245](https://github.com/Estuardo666/City-Listing/actions/runs/33590635245), incluido seguimiento, insignias, contraseña, recomendaciones, transmisiones, guardados enriquecidos y la regresión de role público. El smoke de producción también documenta que `NEXTAUTH_URL` sigue apuntando al host histórico y requiere corrección en Vercel. PR #2 permanece `CLEAN`; GitGuardian y Vercel Preview están verdes.
