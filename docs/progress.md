...
- Auditoría CP9: rama `checkpoint/cp-9-next16-audit` actualiza Next a `16.3.4`, migra `middleware` a `proxy` y deja el audit de producción en cero; [CI 33538932227](https://github.com/Estuardo666/City-Listing/actions/runs/33538932227) valida el SHA actual y PR #2 queda abierto para revisión antes de fusionar.
